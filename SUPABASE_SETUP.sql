...
-- 2. Select your project: nitjfxxbcptmesfensti
-- 3. Click "SQL Editor" on the left sidebar
-- 4. Create a NEW QUERY and copy-paste the SQL below
-- 5. Click "Run" button
-- 
-- ============================================
...
DROP TABLE IF EXISTS step_confirmations CASCADE;
...
ALTER TABLE step_confirmations ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Allow public access to step_confirmations" ON step_confirmations
  FOR ALL USING (true) WITH CHECK (true);
